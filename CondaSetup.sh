...
conda install -c conda-forge numpy pandas scipy scikit-learn xarray matplotlib pyproj jupyter notebook numba llvmlite harmonica xrft simplekml rasterio -y
